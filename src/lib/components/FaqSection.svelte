...
<section class="faq-section landing-page-section">
    <h2 class="mb-l">
    ...
    <div class="additional-info">
        ...
        <a href="https://t.me/pm_moshirpoor">
            <p>
                Hit me up on twitter <img class="telegram-icon" src={telegramIcon} alt="telegramIcon" />
            </p>
        </a>
    </div>
</section>
